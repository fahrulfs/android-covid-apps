...
public class tab1 extends Fragment {
    ...
    public tab1() {}// harus kosong
    /** Gunakan metode pabrik ini untuk membuat instance baru dari
     * fragmen ini menggunakan parameter yang disediakan.
     * @param param1 Parameter 1.
     * @param param2 Parameter 2.
     * @return Contoh baru dari tab1 fragmen*/
    // TODO: Ganti nama dan ubah jenis dan jumlah parameter
    public static tab1 newInstance(String param1, String param2) { //metode statis yang ditentukan dan meneruskan parameter apapun melalui argumen
